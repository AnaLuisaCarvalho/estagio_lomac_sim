...
class TileFCCDetectorConstruction : public G4VUserDetectorConstruction
{
  public:
    TileFCCDetectorConstruction();
    ...
    G4LogicalVolume* GetFiberVolume() const { return fFiberVolume; }
